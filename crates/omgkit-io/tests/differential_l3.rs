...
/// 下面六条非四面体的用例正是这样 —— 我方两次都写不出,两串相同,收敛判据全绿,
/// 而分子的立体信息一次都没落到纸上。所以这一列单独比、单独钉。
///
/// 那六条里还藏着更重的一件事:`[Pt@SP1](Cl)(Cl)(N)N` 与 `[Pt@SP3](Cl)(Cl)(N)N`
/// 是**两个不同的分子**(顺铂与反铂),我方的规范串都是 `N[Pt](N)(Cl)Cl` ——
/// 写不出非四面体立体的代价不是“少个记号”,是两个分子塌成一串。
/// 写出器补上 `@SP`/`@TB`/`@OH` 之后这张表会红,那时删掉对应行即可
...
const STEREO_MISMATCH: &[(&str, &str)] = &[
    ...
    ("[C@H]1CCCCC1O", "同上"),
    ("[Pt@SP1](Cl)(Cl)(N)N", "我方写不出:平面四方 `@SP`"),
    ("[Pt@SP3](Cl)(Cl)(N)N", "我方写不出:平面四方 `@SP`"),
    ("F[P@TB15](Cl)(Br)(I)S", "我方写不出:三角双锥 `@TB`"),
    ("C[Co@OH25](N)(O)(S)(P)Cl", "我方写不出:八面体 `@OH`"),
    ("[C@SP1](F)(Cl)(Br)I", "我方写不出:平面四方 `@SP`(碳上的)"),
    (
